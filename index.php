    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="index.php"><img src="assets/images/icon/icon.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            <img class="avatar user-thumb" src="assets/images/author/man.png" alt="avatar">
        ...
        <footer>
            <div class="footer-area">
                <p>Contact us on <a href="https://www.facebook.com/Bravo.KBV/">Facebook</a>.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
